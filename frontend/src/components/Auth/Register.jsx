...
const Register = (props) => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-800">
      ...
      >
        <h2 className="text-2xl font-bold mb-6 text-center text-orange-600">Create Account</h2>
        ...
        <div className="mb-4">
          ...
          <input
            className="sshadow appearance-none border border-gray-700 rounded w-full py-2 px-3 bg-gray-800 text-gray-300 leading-tight focus:outline-none focus:shadow-outline"
            type="password"
            id="password"
            value={password}
